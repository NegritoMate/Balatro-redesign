...
export default function Balatro({
  ...
  // Keep the props reference updated
  useEffect(() => {
    propsRef.current = {
      spinRotation,
      spinSpeed,
    ...
    // Dynamically update WebGL uniforms in-place without context recreation
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpinRotation: { value: initialProps.spinRotation },
        uSpinSpeed: { value: initialProps.spinSpeed },
        uOffset: { value: initialProps.offset },
        uColor1: { value: hexToVec4(initialProps.color1) },
        uColor2: { value: hexToVec4(initialProps.color2) },
        uColor3: { value: hexToVec4(initialProps.color3) },
        uContrast: { value: initialProps.contrast },
        uLighting: { value: initialProps.lighting },
        uSpinAmount: { value: initialProps.spinAmount },
        uPixelFilter: { value: initialProps.pixelFilter },
        uSpinEase: { value: initialProps.spinEase },
        uIsRotate: { value: initialProps.isRotate },
